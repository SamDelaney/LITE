...
class Ui_LITE(object):
    def setupUi(self, LITE):
        ...
        self.DataSourceReferenceLayout.addWidget(self.dataSourceReferenceBox)
        ...
        spacerItem14 = QtWidgets.QSpacerItem(40, 15, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
        self.copyNotificationLayout.addItem(spacerItem14)
        self.lastUpdatedLabel = QtWidgets.QLabel(self.formatExample)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lastUpdatedLabel.sizePolicy().hasHeightForWidth())
        self.lastUpdatedLabel.setSizePolicy(sizePolicy)
        self.lastUpdatedLabel.setMaximumSize(QtCore.QSize(16777215, 15))
        font = QtGui.QFont()
        font.setKerning(False)
        self.lastUpdatedLabel.setFont(font)
        self.lastUpdatedLabel.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lastUpdatedLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.lastUpdatedLabel.setObjectName("lastUpdatedLabel")
        self.copyNotificationLayout.addWidget(self.lastUpdatedLabel)
        ...
        self.fontStyleLayout.addItem(spacerItem16)
    ...
    def retranslateUi(self, LITE):
        ...
        self.lastUpdatedLabel.setText(_translate("LITE", "Last Updated:"))
